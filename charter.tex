...
\item La simulación de PLC mediante /texit{software} es condición suficiente para demostrar la viabilidad técnica y financiera del proyecto.
...
\begin{consigna}{black}
\begin{enumerate}
\item Grupo de requerimientos asociados con insumos:
	\begin{enumerate}
	\item Disponibilidad de 600 horas de cómputo en la nube para la ejecución de los servicios referidos en \autoref{fig:diagBloques} (estimación monetaria pendiente).
	\item Disponibilidad de simulador tipo KepServerEX para representar virtualmente datos de PLC.
	\item Disponibilidad de datos simulados suficientes para entrenar modelo de aprendizaje automático.
	\end{enumerate}
\item Grupo de requerimientos asociados con temática:
	\begin{enumerate}
	\item Disponibilidad de experto en la temática para validar enfoque de negocio.
	\end{enumerate}
\end{enumerate}
...
\begin{consigna}{red}
\textit{NOTA: esta sección se deja vacía hasta tener la clase de Metodologías ágiles.}
