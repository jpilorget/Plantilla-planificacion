...
\begin{figure}[htpb]
\centering 
\includegraphics[width=.7\textwidth]{./Figuras/diagrama-bloques.png}
...
\begin{enumerate}
\item Planificación del proyecto (48 hs)
	\begin{enumerate}
	\item Definición del plan de proyecto (24 hs)
	\item Desglose de tareas del plan  (16 hs)
	\item Aprobación del plan (8 hs)
	\end{enumerate}
		\item Investigación preliminar (72 hs)
	\begin{enumerate}
	\item Analizar casos de uso similares (16 hs)
	\item Revisar documentación de servicios propuestos (32 hs)
	\item Evaluar alternativas de simulación de datos (16 hs)
	\item Recopilar código y documentación de soluciones (8 hs)
	\end{enumerate}

\item Prueba de concepto (112 hs)
	\begin{enumerate}
